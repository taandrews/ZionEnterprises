...
const serviceLinks = [
  { name: 'First Time Home Buyer', href: '/first-time-buyer' },
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-[1.5fr_1fr_1fr_1fr]" style={{ paddingTop: '80px', paddingBottom: '80px', gap: '32px' }}>
          ...
          <div>
            <Link href="/" className="inline-flex items-center gap-1.5 mb-7">
              <span className="font-heading font-800 text-[22px] text-white tracking-tight">ZION</span>
              <span className="text-gold/40 text-[9px] font-heading font-bold tracking-[0.2em] uppercase">Enterprises</span>
            </Link>
